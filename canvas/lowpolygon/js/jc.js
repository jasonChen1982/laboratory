(function(){
	for(var a=0,b=["ms","moz","webkit","o"],c=0;c<b.length&&!window.requestAnimationFrame;++c)
		...
		if(!window.requestAnimationFrame)window.requestAnimationFrame=function(b){var c=(new Date).getTime(),f=Math.max(0,16-(c-a)),g=window.setTimeout(function(){b(c+f)},f);a=c+f;return g};if(!window.cancelAnimationFrame)window.cancelAnimationFrame=function(a){clearTimeout(a)}
})();
...
CAV.Color=function(a,b){
	...
	this.hex=a||"#000000";
	this.opacity=CAV.Utils.isNumber(b)?b:1;this.set(this.hex,this.opacity);
};
CAV.Color.prototype={
	set:function(a,b){
...
CAV.Mesh.prototype.update=function(a,b){
	...
	if(b)for(c=this.geometry.triangles.length-1;c>=0;c--){
		...
		for(e=a.length-1;e>=0;e--){
			f=a[e],CAV.Vector3.subtractVectors(f.ray,f.position,d.centroid),
			CAV.Vector3.normalise(f.ray),g=CAV.Vector3.dot(d.normal,f.ray),
