...
var Viewer = function (_EventDispatcher) {
  ...
  createClass(Viewer, [{
    ...
    value: function update() {
      this.timeline();
      var snippet = this.snippet * this.timeScale;
      this.dispatchEvent({
        type: 'pretimeline',
        snippet: snippet
      });
    ...
    key: 'addPrimers',
    value: function addPrimers(primer) {
      if (arguments.length > 1) {
        for (var i = 0; i < arguments.length; i++) {
          this.addPrimers(arguments[i]);
        }
        return this;
      }

      if (primer instanceof Primer) {
        if (primer.parent !== null) {
          primer.parent.removePrimers(primer);
        }
        primer.parent = this;
    ...
    key: 'removePrimers',
    value: function removePrimers(primer) {
      if (arguments.length > 1) {
        for (var i = 0; i < arguments.length; i++) {
          this.removePrimers(arguments[i]);
        }
        return this;
      }

      var index = this.primers.indexOf(primer);
...
var EffectComposer = function () {
  ...
  createClass(EffectComposer, [{
    ...
    key: 'render',
    value: function render(scene, camera, delta) {
      this.ship(scene, camera);
    ...
    key: 'ship',
    value: function ship(scene, camera) {
      if (scene instanceof three.Object3D && camera instanceof three.Camera) {
        this.passes[0].scene = scene;
        this.passes[0].camera = camera;
      }
    }
  }]);
...
var ARViewer = function (_Viewer) {
  ...
  function ARViewer(options) {
    ...
    var _options$width = options.width,
        ...
        _options$frameWidth = options.frameWidth,
    ...
    /**
     * whether enable effect composer or not
     * @member {Boolean}
     */
    _this.aeEnable = options.aeEnable || false;

    /**
     * effect update delta
     * @member {Number}
     */
    _this.aeDelta = Utils.isNumber(options.aeDelta) ? options.aeDelta : 0;

    /**
     * ARGlue map, deposit all ARGlue object
     *
     * @member {Group}
     */
    _this.ars = new three.Group();
  ...
  createClass(ARViewer, [{
    ...
    value: function render() {
      ...
      if (this.autoClear) {
        var renderTarget = this.aeEnable ? this.composer.readBuffer : null;
      ...
      this.aerender(this.scene, this.camera);
    ...
    key: 'primingPaint',
    value: function primingPaint() {
      var readBuffer = this.aeEnable ? this.composer.readBuffer : null;
      for (var i = 0; i < this.primers.length; i++) {
        var primer = this.primers[i];
        if (primer.enable) primer.render(this.renderer, readBuffer);
      }
    }
  }, {
    key: 'aerender',
    value: function aerender(scene, camera) {
      if (this.aeEnable) {
        this.composer.render(scene, camera, this.aeDelta);
      } else {
     ...
     *
     * @param {ARGlue|THREE.Object3D} child display-object which you want show
     * @return {this} this
     */
    ...
    value: function add(child) {
      ...
      if (child.type === 'ARGlue') {
        var name = child.name;
        this.ar_map[name] = child;
        this.ars.add(child);
      } else {
     ...
     *
     * @param {ARGlue|THREE.Object3D} child display-object which you had add before
     * @return {this} this
     */
...
var XRViewer = function (_Viewer) {
  ...
  function XRViewer(options) {
     ...
     */
    _this.interactionManager = new InteractionManager(_this.renderer, _this.scene, _this.camera);
  ...
  createClass(XRViewer, [{
    ...
    value: function xrrender() {
      ...
      if (this.vrmode) {
        var hw = size.width / 2;
        this.composer.setSize(hw, size.height);
        ...
        this.renderer.setScissor(0, 0, hw, size.height);
        this.renderer.setViewport(0, 0, hw, size.height);
        this.aerender(this.scene, this.stereo.cameraL);

        this.renderer.setScissor(hw, 0, hw, size.height);
        this.renderer.setViewport(hw, 0, hw, size.height);
        this.aerender(this.scene, this.stereo.cameraR);
     ...
     * @param {Camera} camera use which one camera to look world
     */
...
var ARPrimer = function (_Primer) {
  inherits(ARPrimer, _Primer);

  function ARPrimer(displayTarget, options) {
    classCallCheck(this, ARPrimer);

    var _this = possibleConstructorReturn(this, (ARPrimer.__proto__ || Object.getPrototypeOf(ARPrimer)).call(this, displayTarget, options));
    ...
    _this.depthTest = depthTest || false;
    _this.depthWrite = depthWrite || false;

    _this.init(_this.getFrames());
    return _this;
  }

  createClass(ARPrimer, [{
    key: 'getFrames',
...
var XRPrimer = function (_Primer) {
  inherits(XRPrimer, _Primer);

  function XRPrimer(frame, options) {
    classCallCheck(this, XRPrimer);

    var _this = possibleConstructorReturn(this, (XRPrimer.__proto__ || Object.getPrototypeOf(XRPrimer)).call(this, frame, options));
...
exports.ARPrimer = ARPrimer;
exports.XRPrimer = XRPrimer;
...
//# sourceMappingURL=three.tofu.js.map
