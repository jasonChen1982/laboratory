...
function Bubble() {
    ...
    this.doc = s.paper.circle(0, 0, this.radius);// fill:"#E50012"
		this.opacity = Math.random() * 0.3 + .7; //设置不透明度
...
Bubble.prototype.update = function() {
    ...
    this.doc.attr({ transform: 'matrix(1,0,0,1,' + this.x + ',' + this.y + ')' });
}
    /* 柱状喷泉式泡泡 */
function Stage() {
		this.max = 80;
...
// var bubbleMain = new Bubble("bubble");
// bubbleMain.init();
